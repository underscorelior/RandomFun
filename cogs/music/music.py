...
class Music(commands.Cog):
    ...
    async def volume(self, ctx, volume: int):
        ...
        max_vol = 250#self.config["max_volume"]
        ...
        if user != self.bot.user and message.author == self.bot.user:
            ...
            if message.guild and message.guild.voice_client:
                ...
                if permissions.administrator or (
                    ...
                    bot = message.guild.voice_client
                    if reaction.emoji == "⏯":
                        # pause audio
                        self._pause_audio(bot)
                    elif reaction.emoji == "⏭":
                        ...
                        bot.stop()  # skip ahead
                elif reaction.emoji == "⏭" and "true" and user_in_channel and message.guild.voice_client and message.guild.voice_client.channel:
